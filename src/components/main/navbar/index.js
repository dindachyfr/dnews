            ...
            <header className={`container-fluid bg-cream g-0 py-3 px-5 d-flex justify-content-between align-items-center`}>
                ...
                <div className="right-section d-flex align-items-center">
                    {auth ? (<>
                        ...
                        <Image src={profile?.profile_picture ? profile.profile_picture : Kucing} blurDataURL={Kucing} width={35} height={35} className='radius-50' alt='' onClick={()=>router.push('/main/profile-edit')} />
                    </>) : (
                        <>
                            <span

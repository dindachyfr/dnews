        ...
        <>
            <header className={`container-fluid bg-cream g-0 py-3 px-5 d-flex justify-content-between align-items-center`}>
                ...
                <div className="navbar-menu w-50 d-flex justify-content-between align-items-center">
                    <span
                        className={home ? "text-blue pointer" : "text-blue-light pointer"}
                        name="setHome"
                        onClick={handleNavigate1}>Home</span>
                    <span
                        className={articles ? "text-blue pointer" : "text-blue-light pointer"}
                        onClick={handleNavigate2}>Articles</span>
                    <span
                        className={cat ? "text-blue pointer" : "text-blue-light pointer"}
                        onClick={handleNavigate3}>Category</span>
                    <span
                        className={about ? "text-blue pointer" : "text-blue-light pointer"}
                ...
                <div className="right-section d-flex align-items-center">
                    {auth ? (<>
                        ...
                        <Image src={Kucing} width={35} height={35} className='radius-50' alt='' onClick={()=>router.push('/main/profile-edit')} />
                    </>) : (
                        <>
                            <span

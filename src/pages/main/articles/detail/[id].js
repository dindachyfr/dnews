    ...
    return (
        <Layout>
            ...
            <main className="container-fluid g-0 bg-cream p-5">
                ...
                <section className={`upper-section w-100 d-flex flex-fill px-5`}>
                ...
                <section className="w-100 text-wrap text-blue lh-base p-5">
                    {article?.content}
                    <br />
                    <br />
                ...
                <section className="w-50 mb-3">
                    ...
                    <div className="input-comment-section d-flex justify-content-between">
                        ...
                        <p className="fw-bold text-blue pointer" onClick={handleSubmit}>Submit</p>
                    </div>

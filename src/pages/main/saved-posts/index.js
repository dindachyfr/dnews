...
import { getSaved } from '../../api/article'
            ...
            <Sidebar>
                ...
                return (
                  ...
                  <div className="rec-right p-3 d-flex flex-fill flex-column justify-content-between">
                    ...
                    {/* bagian sini mapping dummy aja biar banyak */}
                    {/* <div className=" mt-3 lower-category w-100 d-flex justify-content-between flex-wrap">
                    {saved.map((item, index) => {
                return (
                  <div 
